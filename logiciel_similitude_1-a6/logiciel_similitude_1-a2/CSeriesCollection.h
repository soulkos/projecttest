...
// CSeriesCollection classe wrapper

class CSeriesCollection : public COleDispatchDriver
{
public:
	CSeriesCollection(){} // Appelle le constructeur par défaut COleDispatchDriver
