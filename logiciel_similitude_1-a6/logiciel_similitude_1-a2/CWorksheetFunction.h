...
// CWorksheetFunction classe wrapper

class CWorksheetFunction : public COleDispatchDriver
{
public:
	CWorksheetFunction(){} // Appelle le constructeur par défaut COleDispatchDriver
