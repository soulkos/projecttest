...
private:	
	int Xscale; //echelle pour les petites valeur de X 
	int Yscale;	//echelle pour les petites valeur de Y

	int tickSpace;	//number of pixels between "x" axis ticks

	int tickXSpace;	//number of pixels between "x" axis ticks
	int tickYSpace;	//number of pixels between "y" axis ticks
	...
	int numXTicks;				//AXE x
	int minXTick, maxXTick;
	int numYTicks;				//AXE y
	int minYTick, maxYTick;
...
public:
	...
	void SetTickLimitsXY(int minXTickValue, int maxXTickValue, int XtickStep,int minYTickValue, int maxYTickValue, int YtickStep);
	//void SetTickLimitsXY(float minXTickValue,float maxXTickValue,float XtickStep,float minYTickValue,float maxYTickValue,float YtickStep);
...
private:
	void DrawAxis(CDC* pDC,int x,int y);
