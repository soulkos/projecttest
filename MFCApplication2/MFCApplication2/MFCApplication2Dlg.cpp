...
// gestionnaires de messages pour CMFCApplication2Dlg
...
{
	// TODO: ajoutez ici le code de votre gestionnaire de notification de contrôle
	CRegression pObjectTest;
	CRegression pObjectRecepteur;
	*pObjectTest.pDegree = 5;
	pObjectRecepteur = pObjectTest;
	CDialogEx::OnOK();
}
